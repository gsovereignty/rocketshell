...
- the owner of a direct parent listed by each referenced previous revision.

Only the owner MAY add or remove maintainers.

Every owner-authored revision MUST list the owner and every direct parent owner
as maintainers. Existing maintainers remain listed unless the owner removes them.

Maintainer-authored revisions MUST copy the previous maintainer list unchanged.

Direct-parent-owner-authored revisions MUST copy the previous maintainer list
unchanged.
