...
describe("service worker cache policy", () => {
  it("bypasses cache for built-in registry and artifacts at root scope", () => {
    ...
    expect(isBuiltInNappletRequest("/napplets.dev.json", "/")).toBe(true);
    expect(isBuiltInNappletRequest("/napplets.dev/view-problem/index.html", "/")).toBe(true);
  });
  ...
  it("bypasses cache for GitHub Pages scoped built-ins only", () => {
    ...
    expect(isBuiltInNappletRequest("/rocketshell/napplets.dev.json", "/rocketshell/")).toBe(true);
    expect(isBuiltInNappletRequest("/rocketshell/napplets.dev/view-problem/index.html", "/rocketshell/")).toBe(true);
