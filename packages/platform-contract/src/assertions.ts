import { REQUIRED_DOMAINS, type PlatformDomain } from "./domains.js";

export interface CapabilitySource { supports(domain: string): boolean }

export function assertPlatformProfile(source: CapabilitySource, required: readonly PlatformDomain[] = REQUIRED_DOMAINS): void {
